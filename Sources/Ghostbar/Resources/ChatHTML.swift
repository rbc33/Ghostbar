...
#settings-btn{-webkit-appearance:none;appearance:none;background:none;border:none;
  color:var(--muted);line-height:0;padding:0 4px;cursor:pointer;
  transition:color .15s,transform .3s;-webkit-app-region:no-drag}
